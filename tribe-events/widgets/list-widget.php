		...
		foreach ( $posts as $post ) :
			...
			<li class="tribe-events-list-widget-events clearfix <?php tribe_events_event_classes() ?>">
				...
				<div class="events-inner clearfix">
					...
					<div class="codinghunters-event-venue">
				...
				<div class="codinghunters-events-button">
					<a class="button" href="#"><?php echo esc_html__( 'See this event', 'codinghunters' ); ?></a>
				</div>
			</li>
		<?php
		endforeach;
...
// No events were found.
	...
	<p><?php printf( esc_html__( 'There are no upcoming %s at this time.', 'codinghunters' ), $events_label_plural_lowercase ); ?></p>
<?php
endif;