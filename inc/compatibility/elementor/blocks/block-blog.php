 ...
 * @since 1.0.0
 */
class Codinghunters_Blog extends Widget_Base {
	...
	public function get_title() {
		return __( 'aThemes: Blog', 'codinghunters' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'categories',
			[
				'label' => __( 'Select your categories', 'codinghunters' ),
		...
		$this->add_control(
			'number',
				[
				'label'   => __( 'Number of posts', 'codinghunters' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Content', 'codinghunters' ),
		...
		$this->add_control(
			'heading_title',
			[
				'label' => __( 'Post Title', 'codinghunters' ),
		...
		$this->add_control(
			'date_bg_color',
			[
				'label' => __( 'Background color', 'codinghunters' ),
				...
				'condition' => [
					'_skin' => 'codinghunters_athemes_blog_skin_4',
				],					
			]
		);		
...
Plugin::instance()->widgets_manager->register_widget_type( new Codinghunters_Blog() );