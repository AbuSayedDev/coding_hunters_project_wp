...
add_action( 'elementor/init', 'codinghunters_register_image_icon_skin' );

function codinghunters_register_image_icon_skin() {
	
	class codinghunters_Image_Icon_Box_Skin extends Elementor\Skin_Base {
		...
		public function get_id() {
			return 'codinghunters_image_icon_skin';
		}

		public function get_title() {
			return __( 'List style', 'codinghunters' );
		}
		...
		public function register_controls( $controls ) {
		    ...
		    $controls->add_control( 'general_color',
		        [
			        'label' => __( 'General color', 'codinghunters' ),
...
add_action( 'elementor/widget/athemes-image-icon-box/skins_init', function( $widget ) {
   $widget->add_skin( new Codinghunters_Image_Icon_Box_Skin( $widget ) );
} );
