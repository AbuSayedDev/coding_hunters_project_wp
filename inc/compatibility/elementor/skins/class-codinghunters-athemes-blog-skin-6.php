...
add_action( 'elementor/init', 'codinghunters_register_athemes_blog_skin_6' );

function codinghunters_register_athemes_blog_skin_6() {
	
	class Codinghunters_aThemes_Blog_Skin_6 extends Elementor\Skin_Base {
		...
		public function get_id() {
			return 'codinghunters_athemes_blog_skin_6';
		}

		public function get_title() {
			return __( 'Style 6', 'codinghunters' );
		}
...
add_action( 'elementor/widget/athemes-blog/skins_init', function( $widget ) {
   $widget->add_skin( new Codinghunters_aThemes_Blog_Skin_6( $widget ) );
} );
