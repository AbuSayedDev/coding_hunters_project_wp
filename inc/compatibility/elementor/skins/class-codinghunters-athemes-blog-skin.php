...
add_action( 'elementor/init', 'codinghunters_register_athemes_blog_skin' );

function codinghunters_register_athemes_blog_skin() {
	
	class Codinghunters_aThemes_Blog_Skin extends Elementor\Skin_Base {
		...
		public function get_id() {
			return 'codinghunters_athemes_blog_skin';
		}

		public function get_title() {
			return __( 'Style 2', 'codinghunters' );
		}
		...
		$controls->add_control(
			'heading_rm',
			[
				'label' => __( 'Read more link', 'codinghunters' ),
							...
							<div class="col-md-12">
								<div class="post-item large-post">
									...
									<div class="post-content">	
										...
										<a class="read-more" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php esc_html_e( 'Read more >>', 'codinghunters' ); ?></a>
									</div>	
								</div>				
							</div>
...
add_action( 'elementor/widget/athemes-blog/skins_init', function( $widget ) {
   $widget->add_skin( new Codinghunters_aThemes_Blog_Skin( $widget ) );
} );
