...
//Get the options
$above_phone_number = get_theme_mod( 'above_phone_number', esc_html__( 'Call us', 'codinghunters' ) );
$phone_number 		= get_theme_mod( 'phone_number', '999.999.999' );
$above_address		= get_theme_mod( 'above_address', esc_html__( 'Address', 'codinghunters' ) );
$address			= get_theme_mod( 'address_details', esc_html__( 'Brooklyn Street', 'codinghunters' ) );
$above_opening		= get_theme_mod( 'above_opening', esc_html__( 'Opening hours', 'codinghunters' ) );
$opening_hours		= get_theme_mod( 'opening_hours', esc_html__( '9-18 Mon-Fri', 'codinghunters' ) );
$cta_text			= get_theme_mod( 'cta_text_menustyle4', esc_html__( 'Get a quote', 'codinghunters' ) );
