...
if ( ! isset( $courses ) ) {
	esc_html_e( 'No courses', 'codinghunters' );
...
<div class="archive-course-widget-outer codinghunters-course <?php esc_attr( $instance["css_class"] ); ?>">
                ...
                <div class="course-entry-inner">
                    ...
                    <div class="course-detail">
                        ...
                        <?php if ( ! empty( $instance['show_teacher'] ) ) { ?>
                            <div class="course-meta-field course-instructor"><?php echo esc_html( 'By', 'codinghunters' ); ?>&nbsp;<?php echo $course->get_instructor_html(); ?></div>
                        <?php } ?>
                        ...
                        <div class="course-meta-data">                           
                            ...
                            <?php if ( ! empty( $instance['show_lesson'] ) ) { ?>
                                <div class="course-lesson-number course-meta-field">
                                    ...
                                    echo $lesson_count > 1 ? sprintf( __( '%d lessons', 'codinghunters' ), $lesson_count ) : sprintf( __( '%d lesson', 'codinghunters' ), $lesson_count ); ?>
                                </div>
                            <?php } ?>
                        </div>
                    </div>
